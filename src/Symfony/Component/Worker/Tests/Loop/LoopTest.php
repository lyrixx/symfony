...
class LoopTest extends TestCase
{
    ...
    {
        yield array(new \AMQPConnectionException('AMQP connexion error.'), 'error    Worker a_queue_name errored, shutting down. (AMQP connexion error.)');
        yield array(new \Exception('oups.'), 'error    Worker a_queue_name errored, shutting down. (oups.)');
    }
